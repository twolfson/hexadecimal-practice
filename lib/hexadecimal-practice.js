...
function HexadecimalPractice(params) {
  ...
  var maxDigits = parseInt(maxDigitsHex, 16);
  this.maximum = Math.pow(16, maxDigits);
  assert(!isNaN(this.maximum),
...
HexadecimalPractice.prototype = {
  ...
  ask: function (done) {
    ...
    var a = Math.floor(this.randomNumberGenerator() * this.maximum);
    var aStr = a.toString(16);
    var b = Math.floor(this.randomNumberGenerator() * this.maximum);
