...
function HexadecimalPractice(params) {
  ...
  assert(params, '`params` was not provided to the `HexadecimalPractice` constructor. Please provide it.');
  assert(params.prompt, '`params.prompt` was not provided to the `HexadecimalPractice` constructor. Please provide it.');
